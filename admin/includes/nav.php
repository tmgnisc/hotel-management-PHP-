...
<aside id="sidebar" class="hidden md:flex fixed left-0 top-0 h-screen w-64 bg-gray-900 text-white flex-col z-50 shadow-2xl">
    ...
    <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        <a href="gallery_images.php" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 <?php echo ($current_page == 'gallery_images.php') ? 'bg-indigo-600 text-white shadow-lg' : 'text-gray-300 hover:bg-gray-800 hover:text-white'; ?>">
            <span class="mr-3">🖼️</span>
            <span class="font-medium">Gallery Images</span>
        </a>
        <a href="contact_messages.php" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 <?php echo ($current_page == 'contact_messages.php') ? 'bg-indigo-600 text-white shadow-lg' : 'text-gray-300 hover:bg-gray-800 hover:text-white'; ?>">
            <span class="mr-3">📨</span>
        ...
        <a href="purchase_details.php" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 <?php echo ($current_page == 'purchase_details.php') ? 'bg-indigo-600 text-white shadow-lg' : 'text-gray-300 hover:bg-gray-800 hover:text-white'; ?>">
            <span class="mr-3">🧾</span>
...
<nav id="navMenu" class="md:hidden bg-gray-900 text-white hidden">
    <ul class="space-y-1 p-4">
        ...
        <li>
            <a href="gallery_images.php" class="flex items-center px-4 py-3 rounded-lg transition-all <?php echo ($current_page == 'gallery_images.php') ? 'bg-indigo-600 text-white' : 'text-gray-300 hover:bg-gray-800'; ?>">
                Gallery Images
            </a>
        </li>
        <li>
            <a href="contact_messages.php" class="flex items-center px-4 py-3 rounded-lg transition-all <?php echo ($current_page == 'contact_messages.php') ? 'bg-indigo-600 text-white' : 'text-gray-300 hover:bg-gray-800'; ?>">
                Contact Messages
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="purchase_details.php" class="flex items-center px-4 py-3 rounded-lg transition-all <?php echo ($current_page == 'purchase_details.php') ? 'bg-indigo-600 text-white' : 'text-gray-300 hover:bg-gray-800'; ?>">
                Purchase Details
            </a>
        </li>
        <li>
